        ...
        dashboardBody(shinyjs::useShinyjs(),
            tabItems(
                ...
                tabItem("GEE_results", tabBox(
                  ...
                  div(style="float:right;margin-top: -400px;padding:10px;font-size:80%;",downloadButton("Download_Results", label = "Download",style="width: 150px;color: #fff; background-color: #337ab7; border-color: #2e6da4")))
                ),

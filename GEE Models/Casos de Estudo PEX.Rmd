...
GEEPACK_Modelo_70_30_ex = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações ) , id = Processo , data = train_70, family = binomial, corstr = "exchangeable",scale.fix = TRUE)
summary(GEEPACK_Modelo_70_30_ex)
MESS::QIC(GEEPACK_Modelo_70_30_ex)

GEEPACK_Modelo_70_30_ar1 = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações) , id = Processo , data = train_70, family = binomial, corstr = "ar1",scale.fix = TRUE)
summary(GEEPACK_Modelo_70_30_ar1)
MESS::QIC(GEEPACK_Modelo_70_30_ar1)

GEEPACK_Modelo_70_30_ind = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações ) , id = Processo , data = train_70, family = binomial, corstr = "independence",scale.fix = TRUE)
...
GEEPACK_Modelo_75_25_ex = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações ) , id = Processo , data = train_75, family = binomial, corstr = "exchangeable")
summary(GEEPACK_Modelo_75_25_ex)
MESS::QIC(GEEPACK_Modelo_75_25_ex)

GEEPACK_Modelo_75_25_ar1 = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações) , id = Processo , data = train_75, family = binomial, corstr = "ar1")
summary(GEEPACK_Modelo_75_25_ar1)
MESS::QIC(GEEPACK_Modelo_75_25_ar1)

GEEPACK_Modelo_75_25_ind = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações ) , id = Processo , data = train_75, family = binomial, corstr = "independence")
...
GEEPACK_Modelo_80_20_ex = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações) , id = Processo , data = train_80, family = binomial, corstr = "exchangeable")
summary(GEEPACK_Modelo_80_20_ex)
MESS::QIC(GEEPACK_Modelo_80_20_ex)

GEEPACK_Modelo_80_20_ar1 = geeglm(PEX~(I(Idade) + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações) , id = Processo , data = train_80, family = binomial, corstr = "ar1")
summary(GEEPACK_Modelo_80_20_ar1)
MESS::QIC(GEEPACK_Modelo_80_20_ar1)

GEEPACK_Modelo_80_20_ind = geeglm(PEX~(Idade + Sexo + Lat + Dilpp + Internos + Local_da_LIO + Complicações) , id = Processo , data = train_80, family = binomial, corstr = "independence")
